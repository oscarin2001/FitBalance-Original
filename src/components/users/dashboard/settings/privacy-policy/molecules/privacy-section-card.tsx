...
import type { PrivacySection } from "../data/privacy-policy-content";
import { Card, CardContent } from "@/components/ui/card";
import { cn } from "@/lib/utils";

type PrivacySectionCardProps = {
  section: PrivacySection;
};

function toneClasses(tone: PrivacySection["tone"]) {
  if (tone === "teal") {
      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400">Aviso de privacidad</p>
